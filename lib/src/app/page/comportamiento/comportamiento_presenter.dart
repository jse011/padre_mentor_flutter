...
class ComportamientoPresenter extends Presenter{
  ...
  ComportamientoPresenter(this.alumnoId, this.programaAcademicoId, this.anioAcademicoId, this.fotoAlumno, DataCursoRepository cursoRepo, DeviceHttpDatosRepositorio httpDatosRepo, UsuarioAndConfiguracionRepository usuarioConfigRepo): _getCalendarioPerido = GetCalendarioPerido(cursoRepo), super();
...
class _GetCalendarioPeridoCase extends Observer<GetCalendarioPeridoResponse>{
  final ComportamientoPresenter presenter;
