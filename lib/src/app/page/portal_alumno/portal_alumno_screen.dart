...
class PortalAlumnoScreen extends StatefulWidget{
  final AnimationController animationController;

  const PortalAlumnoScreen({Key key, this.animationController}) : super(key: key);

  @override
  _PortalAlumnoScreenState createState() => _PortalAlumnoScreenState();

}

class _PortalAlumnoScreenState extends State<PortalAlumnoScreen>
